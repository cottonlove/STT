...
from sklearn.model_selection import train_test_split #cross validation 찾아보기
...
def load_dataset(transcripts_path):
    ...
    with open(transcripts_path) as f:
        print("open transcripts_path")
        for idx, line in enumerate(f.readlines()):
            try:
                audio_path, korean_transcript, transcript = line.split('\t') #korean_transcript: 한글 전사, transcript: ID
    ...
    #korean_transcript txt file 가능?


    return audio_paths, transcripts


# 여기를 바꿔서 train/val 바꾸기
